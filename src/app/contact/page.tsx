        ...
        <div className="bg-neutral-50 rounded-2xl p-8 sm:p-12">
          <div className="space-y-6">
            <div>
              ...
              <a href="mailto:contact@cellfinremit.com" className="text-[#196642] hover:underline">
                contact@cellfinremit.com
              </a>
            </div>
            ...
            <div>
              ...
              <p className="text-neutral-600 mt-1">Cellfin Remit Inc.<br />125 Liberty Street, Suite 400<br />New York, NY 10006, USA</p>
            </div>
