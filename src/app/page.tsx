...
export default function Home() {
  ...
  return (
    <div className="font-sans bg-white">
      {/* Hero Section */}
      <section id="hero" className="relative overflow-hidden bg-[#196642] text-white pt-24 pb-16 md:pt-32 md:pb-24">
        {/* Floating Bubbles */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center relative">
            ...
            <div className="relative">
              {/* Decorative Circle */}
              <div className="absolute -left-20 top-1/2 -translate-y-1/2 w-64 h-64 rounded-full bg-[#2d8a5a]/30 blur-3xl -z-10 animate-pulse"></div>
            ...
            <div className="relative mx-auto w-full max-w-[220px] animate-fade-in-up animation-delay-400">
              ...
              >
                <Image src="/assets/mockup.png" alt="Cellfin Remit app screenshot" fill className="object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            ...
            <div 
              ...
              className={`text-center p-8 rounded-2xl bg-[#196642] text-white hover:shadow-xl transition-all duration-300 hover:-translate-y-2 ${
            ...
            >
              ...
              <p className="text-white/90">Cellfin Remit আপনার লেনদেন কে নিরাপদ ও রাখতে সর্বদা সচেষ্ট</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 bg-neutral-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            ...
            >
              <div className="w-16 h-16 rounded-full bg-[#196642] text-white text-2xl font-bold flex items-center justify-center mx-auto mb-6 hover:scale-110 transition-transform duration-300">
                ১
              </div>
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-24 bg-[#196642] text-white">
